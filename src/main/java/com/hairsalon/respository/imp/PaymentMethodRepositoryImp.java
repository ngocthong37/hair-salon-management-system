...
import com.hairsalon.respository.IPaymentMethodRepository;
...
@Repository
@Transactional
public class PaymentMethodRepositoryImp implements IPaymentMethodRepository {

    private static final Logger LOGGER = (Logger) LoggerFactory.getLogger(PaymentMethodRepositoryImp.class);
