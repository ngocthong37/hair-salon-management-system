...
import com.hairsalon.respository.IReview;
...
@Repository
@Transactional
public class ReviewImp implements IReview {

    @Autowired
    SessionFactory sessionFactory;

    private static final Logger LOGGER = (Logger) LoggerFactory.getLogger(ReviewImp.class);
