...
import com.hairsalon.respository.IOrderStatusRepository;
...
@Repository
@Transactional
public class OrderStatusRepositoryImp implements IOrderStatusRepository {

    @Autowired
    SessionFactory sessionFactory;
    private static final Logger LOGGER = (Logger) LoggerFactory.getLogger(OrderStatusRepositoryImp.class);
